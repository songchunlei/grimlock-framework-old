package org.grimlock.uua.server.common;
...
public class MD5 {
	...
	public static void main(String[] args) {
		try {
			...
			String md5Result = MD5
					.getHashString("010000000000000000000100000000000000000000000000012345"
							+ timeStr);
			System.out.println(md5Result + timeStr);
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
